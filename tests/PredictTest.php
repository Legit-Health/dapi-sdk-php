...
class PredictTest extends TestCase
{
    public function testPsoriasisSeverityAssessment()
    {
        ...
        $mediaAnalyzerArguments = new PredictArguments(
            $this->generateRandom(),
    ...
    public function testAcneFaceAnteriorProjection()
    {
        ...
        $this->assertGreaterThan(0, $response->conclusions);
        $firstConclusion = $response->conclusions[0];
        if ($firstConclusion->pathologyCode === 'Non-specific lesion') {
            $this->assertEmpty($firstConclusion->conclusionCode->code);
            $this->assertNotEmpty($firstConclusion->conclusionCode->codeSystem);
            $this->assertNotEmpty($firstConclusion->pathologyCode);
            $this->assertNotEmpty($firstConclusion->probability);
        } else {
        ...
        $firstConclusion = $response->conclusions[1];
        if ($firstConclusion->pathologyCode === 'Non-specific lesion') {
            $this->assertEmpty($firstConclusion->conclusionCode->code);
            $this->assertNotEmpty($firstConclusion->conclusionCode->codeSystem);
            $this->assertNotEmpty($firstConclusion->pathologyCode);
